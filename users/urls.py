...
urlpatterns = [
    ...
    path("updateUserPayment", UpdateUserPayment.as_view(),
    ...
    path("user-forgot-password", UserForgotPassword.as_view(),
         name="UserForgotPassword"),
    path("complete-forgot-password", CompleteUserForgotPassword.as_view(),
         name="CompleteUserForgotPassword"),
    path("send-user-contact-us-email", SendUserContactUsEmail.as_view(),
         name="SendUserContactUsEmail"),
    path("add-new-sponsor", CreateSponsor.as_view(), name="CreateSponsor"),
    path("getUserFromSlug/<str:slug>",
         GetUserFromSlug.as_view(), name="getUserFromSlug"),
